...
We successfully installed the package on Windows machines. As always things are much harder on Windows :wink:. Pending better solution, we wrote an automatic installation script that install the SDL library and build the package.
